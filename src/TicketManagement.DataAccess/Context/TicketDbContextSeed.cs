        ...
        public async Task Seed()
        {
            ...
            if (!_ticketDbContext.EventSeat.Any())
            {
                ...
                _ticketDbContext.EventSeat.AddRange(new EventSeat[]
                {
                    ...
                    new EventSeat { EventAreaId = areaSeatDto3.Id, Row = 1, Number = 1, State = 0 },
                    ...
                    new EventSeat { EventAreaId = areaSeatDto4.Id, Row = 1, Number = 4, State = 0 },
                    new EventSeat { EventAreaId = areaSeatDto4.Id, Row = 2, Number = 1, State = 0 },
